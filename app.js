...
//Creating constant to use express as app
const app = express();

//Setting EJS views (Templating and layouts)
app.set("view engine", "ejs");

//Setting bodyParser and Public files (CSS)
app.use(bodyParser.urlencoded({ extended: true }));
app.use(express.static("public"));

//Global array where posts will be stored
let posts = [];

//Home EJS response page
...
//About EJS response page
app.get("/about", function (req, res) {
  res.render("about", { aboutContent: aboutStartingContent });
});

//Contact EJS response page
app.get("/contact", function (req, res) {
  res.render("contact", { contactContent: contactStartingContent });
});

//Compose EJS hidden response page
app.get("/compose", function (req, res) {
  res.render("compose");
});

//Handling POST request for composing a new article
